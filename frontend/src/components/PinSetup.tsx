            ...
            >
                ...
                {showBiometric && (
                    <motion.div
                        ...
                        className="flex items-center justify-between bg-white rounded-xl p-4 mb-8 shadow-sm border border-gray-100 cursor-pointer hover:bg-gray-50 transition-colors"
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <span className="text-gray-700 font-medium">Use Biometrics</span>
                                <span className="text-xs text-gray-500">Tap to scan Fingerprint or Face</span>
                            </div>
                        </div>
